...
void PASCALCOMPILER::SCANSTRING(char *STRG, int MAXLENG, char STOPPER)
{
	int LENG;
	SYMCURSOR=SYMCURSOR+2;
...
/* SYMCURSOR NOW POINTS AT FIRST CHARACTER PAST int PART */
	...
	if (*SYMBUFP[SYMCURSOR]=='E')
	{
		...
		E=SYMCURSOR-1;
		if (ENDE<EPART)
			PASCALCOMPILER::CERROR(201); /* CERROR IN REAL CONSTANT */
	};
