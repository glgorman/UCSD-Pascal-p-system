...
void COMPINIT::INITSETS()
{
	...
	m_ptr->BNF::CONSTBEGSYS = SET((5),SYMBOLS::ADDOP,SYMBOLS::INTCONST,
		SYMBOLS::REALCONST,SYMBOLS::STRINGCONST,SYMBOLS::IDENT);
	m_ptr->BNF::SIMPTYPEBEGSYS = SET((1),SYMBOLS::LPARENT) + m_ptr->BNF::CONSTBEGSYS;	
	m_ptr->BNF::TYPEBEGSYS = SET((6),SYMBOLS::ARROW,SYMBOLS::PACKEDSY,
		SYMBOLS::ARRAYSY,SYMBOLS::RECORDSY,SYMBOLS::SETSY,SYMBOLS::FILESY)
	+ m_ptr->BNF::SIMPTYPEBEGSYS;	
	m_ptr->BNF::TYPEDELS = SET((4),SYMBOLS::ARRAYSY,SYMBOLS::RECORDSY,
		SYMBOLS::SETSY,SYMBOLS::FILESY);	
	m_ptr->BNF::BLOCKBEGSYS = SET((9),SYMBOLS::USESSY,SYMBOLS::LABELSY,
		SYMBOLS::CONSTSY,SYMBOLS::TYPESY,SYMBOLS::VARSY,
		SYMBOLS::PROCSY,SYMBOLS::FUNCSY,SYMBOLS::PROGSY,SYMBOLS::IFSY);	
	m_ptr->BNF::SELECTSYS = SET((3),SYMBOLS::ARROW,SYMBOLS::PERIOD,SYMBOLS::LBRACK);	
	m_ptr->BNF::FACBEGSYS = SET((8),SYMBOLS::INTCONST,SYMBOLS::REALCONST,
		SYMBOLS::LONGCONST,SYMBOLS::STRINGCONST,SYMBOLS::IDENT,
		SYMBOLS::LPARENT,SYMBOLS::LBRACK,SYMBOLS::NOTSY);	
	m_ptr->BNF::STATBEGSYS = SET((8),SYMBOLS::BEGINSY,SYMBOLS::GOTOSY,
		SYMBOLS::IFSY,SYMBOLS::WHILESY,SYMBOLS::REPEATSY,
		SYMBOLS::FORSY,SYMBOLS::WITHSY,SYMBOLS::CASESY);	
	m_ptr->BNF::VARS = SET((2),FORMALVARS,ACTUALVARS);
} /*INITSETS*/ ;
...
void COMPILERDATA::SEARCHID(SETOFIDS FIDCLS, CTP &FCP)
{
...
void PASCALSOURCE::SKIP(SETOFSYS FSYS)
{
...
int PASCALCOMPILER::COMPILER_MAIN (LPVOID)
{
	...
	int	LGTH = 0;
	TIME(LGTH,LOWTIME);
	SETOFSYS FSYSM = BNF::BLOCKBEGSYS+BNF::STATBEGSYS-SET(1,SYMBOLS::CASESY);
