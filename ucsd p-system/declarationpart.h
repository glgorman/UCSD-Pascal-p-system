...
/* $I DECPART.A.TEXT*/
/*    COPYRIGHT (C) 1978, REGENTS) THE        */
/*    UNIVERSITY) CALif (ORNIA, SAN DIEGO       */
...
protected:
	...
	SYMBOL LSY;
	bool NOTDONE;
	char *DUMMYVAR; /*for (PRETTY DISPLAY) STACK&& HEAP */
...
protected:
	...
	void VARDECLARATION();
	void PROCDECLARATION(SYMBOL,bool);

public:
	DECLARATIONPART ();
	DECLARATIONPART (COMPILERDATA *);
...
protected:
	PROCDECLARATION(SYMBOL FSY, bool SEGDEC);
